...
VALUES
   ...
   insert into sale(id,description,discount,sale_date,sale_quantity,product_id) values
       ...
       (1001, 'sale-2', 900 , '2024-09-21', 3, 1002),
       (1002, 'sale-3', 150 , '2024-09-22', 8, 1003),
       (1003, 'sale-4', 800 , '2024-09-23', 2, 1004),
       (1004, 'sale-5', 100 , '2024-09-24', 7, 1005),
       (1005, 'sale-6', 300 , '2024-09-25', 6, 1006),
       (1006, 'sale-7', 400 , '2024-09-26', 4, 1007),
       (1007, 'sale-8', 700 , '2024-09-27', 9, 1008);
